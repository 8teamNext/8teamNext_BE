...
def compare_cover_letters(original_text: str, improved_text: str) -> CoverLetterCompareResponse:
    ...
    overall_summary = (
        f"자기소개서가 {imp_words - orig_words} 단어만큼 보완 및 보강되었습니다. "
        f"수정 버전에서는 기존의 수동적이거나 감정적인 표현 대신 구체적인 정량적 성과 지표와 "
        f"구조화된 프로젝트 아키텍처 스택을 제시하여, 실무진 관점에서의 실무 전문성과 설득력을 대폭 강화하였습니다."
    )
